...
## 借鉴D:\wzs\paper_all\seven paper\code\DANet-master\encoding\nn\da_att.py
## 借鉴D:\wzs\paper_all\seven paper\code\Attention-mechanism-implementation-main\models\DaNet.py
...
class Discriminator(nn.Module):
    ...
    def forward(self, x, tsne=False):
        ...
        # 原始2D小波系数矩阵输入到注意力模块（batchSize, 2, 64, 64）
        ## 先输入到位置注意力融合模块
